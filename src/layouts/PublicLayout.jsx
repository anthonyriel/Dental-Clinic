...
export default function PublicLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#e4f2ef] text-slate-900 selection:bg-[#67c4c7]/30 pb-[calc(6.5rem+env(safe-area-inset-bottom))] lg:pb-0">
      ...
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-slate-200/80 shadow-2xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <Link 
              className="hidden lg:inline-block text-sm font-semibold text-slate-700 hover:text-[#67c4c7] transition-colors px-2 py-1" 
      ...
      <MobileBottomNav desktopAt="lg" links={[
